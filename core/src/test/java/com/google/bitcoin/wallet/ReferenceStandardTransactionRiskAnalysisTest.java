...
public class ReferenceStandardTransactionRiskAnalysisTest {
    ...
    public void nonFinal() throws Exception {
        ...
        {
            ReferenceStandardTransactionRiskAnalysis analysis = ReferenceStandardTransactionRiskAnalysis.FACTORY.create(wallet, tx, NO_DEPS);
    ...
    public void nonFinalDependency() {
        ...
        ReferenceStandardTransactionRiskAnalysis analysis = ReferenceStandardTransactionRiskAnalysis.FACTORY.create(wallet, tx2, ImmutableList.of(tx1));
        assertEquals(RiskAnalysis.Result.NON_FINAL, analysis.analyze());
    ...
    public void simpleNonStandardDependency() {
        ...
        ReferenceStandardTransactionRiskAnalysis analysis = ReferenceStandardTransactionRiskAnalysis.FACTORY.create(wallet, tx2, NO_DEPS);
        assertEquals(RiskAnalysis.Result.OK, analysis.analyze());

        analysis = ReferenceStandardTransactionRiskAnalysis.FACTORY.create(wallet, tx2, ImmutableList.of(tx1));
        assertEquals(RiskAnalysis.Result.NON_STANDARD, analysis.analyze());
