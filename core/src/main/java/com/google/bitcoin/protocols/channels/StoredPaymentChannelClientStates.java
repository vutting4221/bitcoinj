    ...
    public byte[] serializeWalletExtension() {
        ...
        try {
            ...
            for (StoredClientChannel channel : mapChannels.values()) {
                ...
                checkState(channel.valueToMe.compareTo(BigInteger.ZERO) >= 0 && channel.valueToMe.compareTo(containingWallet.getParams().getMaxMoney()) < 0);
                checkState(channel.refundFees.compareTo(BigInteger.ZERO) >= 0 && channel.refundFees.compareTo(containingWallet.getParams().getMaxMoney()) < 0);
